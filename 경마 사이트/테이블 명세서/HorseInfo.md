...
CREATE TABLE Breeding (
    ...
    beforeHrEngNm VARCHAR(30),
    FOREIGN KEY (hrNo) REFERENCES Horses(hrNo),
    FOREIGN KEY (brNo) REFERENCES Breeders(brNo)
);
```
...
CREATE TABLE Racing (
    ...
    brand3 VARCHAR(50),
    FOREIGN KEY (hrNo) REFERENCES Horses(hrNo),
    FOREIGN KEY (rhrOwNo) REFERENCES Owners(owNo),
    FOREIGN KEY (rhrMgrNo) REFERENCES Trainers(mgrNo)
);
```
...
CREATE TABLE Imports (
    ...
    breedFarm VARCHAR(40),
    FOREIGN KEY (hrNo) REFERENCES Horses(hrNo),
    FOREIGN KEY (sexMgrNo) REFERENCES Trainers(mgrNo),
    FOREIGN KEY (sexOwNo) REFERENCES Owners(owNo),
    FOREIGN KEY (FOwNo) REFERENCES Owners(owNo),
    FOREIGN KEY (chefHrNo) REFERENCES Horses(hrNo)
);
```
